...
public class SwitchCameraOperator extends QuickSwitchOnOffOperator {
    ...
    protected void doOperate(int index) {
        if (TestContext.mCameraNumber > 10) {
            LogHelper.d(TAG, "[doOperate] do switchCameraOperate, camera number is " + TestContext.mCameraNumber);
            ...
            LogHelper.d(TAG, "[doOperate] do not switchCameraOperate, camera number is " + TestContext.mCameraNumber);
        }
    }
