...
AOV_APP_DEFAULT_BUILT_IN := no
$(warning AOV_APP_DEFAULT_BUILD_IN=$(AOV_APP_DEFAULT_BUILT_IN))
ifeq ($(AOV_APP_DEFAULT_BUILT_IN),yes)
...
LOCAL_STATIC_JAVA_LIBRARIES := vendor.mediatek.hardware.camera.aovservice-V1-java
...
LOCAL_PACKAGE_NAME := AOVTestsApp
