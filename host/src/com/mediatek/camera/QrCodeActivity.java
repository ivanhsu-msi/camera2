 ...
 */
public class QrCodeActivity extends CameraActivity {
      private static final Tag TAG = new Tag("QrCodeActivity");
      private String mQRMode = "com.mediatek.camera.feature.mode.qrcode.QRcodeModeEntry";

	@Override
	protected void onCreateTasks(Bundle savedInstanceState){
	 	getIntent().setAction(mQRMode);
