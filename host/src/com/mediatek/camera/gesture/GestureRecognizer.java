...
public class GestureRecognizer {
    ...
    private static final LogUtil.Tag TAG
            = new LogUtil.Tag(GestureRecognizer.class.getSimpleName());
    ...
    private class ScaleListenerImpl extends ScaleGestureDetector.SimpleOnScaleGestureListener {
        ...
        public boolean onScaleBegin(ScaleGestureDetector detector) {
            boolean res = mListener.onScaleBegin(detector);
            LogHelper.d(TAG, "GestureManager onTouch =  onScaleBegin res = "+ res);
            return res;
        }

        @Override
        public void onScaleEnd(ScaleGestureDetector detector) {
            LogHelper.d(TAG, "GestureManager onTouch =  onScaleEnd");
