...
public class GestureManager {
    ...
    private class GestureNotifier implements OnGestureListener {
        ...
        public boolean onScaleBegin(ScaleGestureDetector scaleGestureDetector) {
            LogHelper.d(TAG, "GestureManager OnGestureListener onScaleBegin");
            Iterator iterator = mGestureListeners.entrySet().iterator();
            OnGestureListener listener;
            while (iterator.hasNext()) {
                Map.Entry map = (Map.Entry) iterator.next();
        ...
        public boolean onScaleEnd(ScaleGestureDetector scaleGestureDetector) {
            LogHelper.d(TAG, "GestureManager OnGestureListener onScaleEnd");
            Iterator iterator = mGestureListeners.entrySet().iterator();
            OnGestureListener listener;
            while (iterator.hasNext()) {
                Map.Entry map = (Map.Entry) iterator.next();
    ...
    private class GestureListenerImpl implements GestureRecognizer.Listener {
        ...
        @Override
        public boolean onScaleBegin(ScaleGestureDetector scaleGestureDetector) {
            boolean res = mGestureNotifier.onScaleBegin(scaleGestureDetector);
            LogHelper.d(TAG, "GestureListenerImpl onScaleBegin res = " + res);
            return res;
        }

        @Override
        public void onScaleEnd(ScaleGestureDetector scaleGestureDetector) {
            LogHelper.d(TAG, "GestureListenerImpl onScaleEnd");
