...
public class ModePickerFragment extends Fragment implements IApp.OnOrientationChangeListener  {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        LogHelper.d(TAG, "onCreateView: mSettingVisibility = " + mSettingVisibility);
        ...
        if (CameraUtil.isHasNavigationBar(getActivity())) {
            ...
            if((CameraUtil.isTablet()||CameraUtil.isAivDevice() || CameraUtil.isAiotDevice()) && 
                ...
                LogHelper.e(TAG,"set setting layout do not contain taskbar height,insetsHeight="+insetsHeight);
                RelativeLayout.LayoutParams params =
                        (RelativeLayout.LayoutParams) settingView.getLayoutParams();
