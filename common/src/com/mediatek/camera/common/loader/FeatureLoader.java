...
import com.mediatek.camera.feature.mode.qrcode.QRcodeModeEntry;
...
import com.mediatek.camera.feature.setting.ainr.AINREntry;
import com.mediatek.camera.feature.setting.afbc.AFBCEntry;
...
import com.mediatek.camera.feature.setting.objecttracking.ObjectTrackingEntry;
...
import com.mediatek.camera.feature.setting.tpi.TpiEntry;
import com.mediatek.camera.feature.setting.videoquality.VideoQualityEntry;
import com.mediatek.camera.feature.setting.vsdofquality.VsdofQualityEntry;
...
import com.mediatek.camera.feature.setting.zoommanualing.ZoomManualingEntry;
...
public class FeatureLoader {
    ...
    private static final String AINR = "com.mediatek.camera.feature.setting.ainr.ainrEntry";
    ...
    private static final String OBJECT_TRACKING = "com.mediatek.camera.feature.setting.objecttracking.ObjectTrackingEntry";
    ...
    private static final String VSDOF_QUALITY = "com.mediatek.camera.feature.setting.vsdofquality.VsdofQualityEntry";
    ...
    private static final String QR_CODE_MODE
            = "com.mediatek.camera.feature.mode.qrcode.QRcodeModeEntry";
    ...
    private static final String TPI
            = "com.mediatek.camera.feature.setting.tpi.TpiEntry";
    private static final String AFBC
            = "com.mediatek.camera.feature.setting.afbc.AFBCEntry";

    private static final String ZMMANUALING
            = "com.mediatek.camera.feature.setting.zoommanualing.ZoomManualingEntry";
    /**
    ...
    private static LinkedHashMap<String, IFeatureEntry> loadClasses(Context context) {
        ...
        IFeatureEntry ainrEntry = new AINREntry(context, context.getResources());
        ainrEntry.setDeviceSpec(deviceSpec);
        entries.put(AINR, ainrEntry);
        ...
        IFeatureEntry objectTrackingEntry = new ObjectTrackingEntry(context, context.getResources());
        objectTrackingEntry.setDeviceSpec(deviceSpec);
        entries.put(OBJECT_TRACKING, objectTrackingEntry);
        ...
        IFeatureEntry vsdofQualityEntry = new VsdofQualityEntry(context, context.getResources());
        vsdofQualityEntry.setDeviceSpec(deviceSpec);
        entries.put(VSDOF_QUALITY, vsdofQualityEntry);
        ...
        IFeatureEntry qrcodeEntry = new QRcodeModeEntry(context, context.getResources());
        qrcodeEntry.setDeviceSpec(deviceSpec);
        entries.put(QR_CODE_MODE, qrcodeEntry);
        ...
        IFeatureEntry tpiEntry = new TpiEntry(context, context.getResources());
        tpiEntry.setDeviceSpec(deviceSpec);
        entries.put(TPI, tpiEntry);

        IFeatureEntry standardHDR10tEntry = new StandardHDR10Entry(context, context.getResources());
        standardHDR10tEntry.setDeviceSpec(deviceSpec);
        entries.put(StandardHDR10, standardHDR10tEntry);

        IFeatureEntry afbcEntry = new AFBCEntry(context, context.getResources());
        afbcEntry.setDeviceSpec(deviceSpec);
        entries.put(AFBC, afbcEntry);

        IFeatureEntry zmManualingEntry = new ZoomManualingEntry(context, context.getResources());
        zmManualingEntry.setDeviceSpec(deviceSpec);
        entries.put(ZMMANUALING, zmManualingEntry);
