...
public interface IAppUi {
    ...
    void addOnViewChangeListener(IZoomManualingViewListener.OnZMChangeViewListener listener);

    void removeOnViewChangeListener(IZoomManualingViewListener.OnZMChangeViewListener listener);
}
