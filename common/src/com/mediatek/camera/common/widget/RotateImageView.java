...
public class RotateImageView extends AppCompatImageView implements Rotatable {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mDrawArea = new Rect(getLeft(),getTop(),getRight(),getBottom());
	mDrawAreaStr = mDrawArea == null?"onDraw":mDrawArea.toShortString();
    }

    private Rect mDrawArea = null;
    private String mDrawAreaStr = "onDraw";


    @Override
    protected void onDraw(Canvas canvas) {
	CameraSysTrace.onEventSystrace(mDrawAreaStr, true, true);
	...
	CameraSysTrace.onEventSystrace(mDrawAreaStr, false, true);
    }
