...
public interface IRecorder {
    ...
    static class RecorderSpec {
        ...
        /**
         * isHEVC used for setVideoEncoder
         * if value is true set VideoEncoder.HEVC
         */
        ...
        /**
         * HDR10 turn on in recording status will be true
         * to make mediaRecorder set parameter to mediaCodec 
         */
        public boolean hdr10Support = false;
    }
}
