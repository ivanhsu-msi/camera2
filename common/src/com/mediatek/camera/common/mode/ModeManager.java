...
public class ModeManager implements IModeListener, IAppUiListener.OnModeChangeListener {
    ...
    private static final String DEFAULT_CAPTURE_MODE = "com.mediatek.camera.common.mode.photo.PhotoModeEntry";
    private static final String DEFAULT_QRCODE_MODE = "com.mediatek.camera.feature.mode.qrcode.QRcodeModeEntry";
    ...
    private String getDefaultModeKey() {
        ...
        }else if(DEFAULT_QRCODE_MODE.equals(action)){
	    defaultModeKey = DEFAULT_QRCODE_MODE;
}
