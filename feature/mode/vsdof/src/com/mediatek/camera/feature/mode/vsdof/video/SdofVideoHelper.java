...
public class SdofVideoHelper {
    private static final Tag TAG = new Tag(SdofVideoHelper.class.getSimpleName());
    ...
    private ISdofVideoDeviceController mCameraDevice;
     ...
     */
    public SdofVideoHelper(ICameraContext context, IApp app, ISdofVideoDeviceController cameraDevice,
                           Handler videoHandler) {
        LogHelper.d(TAG, "[SdofVideoHelper]");
     ...
     */
    public ISdofVideoDeviceController.PreviewCallback getPreviewFrameCallback() {
     ...
     * @return the result.
     */
    public ISdofRecorder.RecorderSpec configRecorderSpec(CamcorderProfile profile, String cameraId,
                                                         CameraDeviceManagerFactory.CameraApi api
            , ISettingManager settingManager) {
        sProfile = profile;
        ISdofRecorder.RecorderSpec recorderSpec = new ISdofRecorder.RecorderSpec();
    ...
    public ContentValues getContentValuesNewVideo(){
        ...
        saveContentValues.put(MediaStore.Video.Media.DATA, filePath);
    ...
    private ContentValues createPhotoValues(Size size) {
        ...
        Location location = mCameraContext.getLocation();
        if (location != null) {
            values.put(MediaStore.Images.ImageColumns.LATITUDE,
    ...
    private ISdofVideoDeviceController.PreviewCallback mPreviewCallback = new
            ISdofVideoDeviceController.PreviewCallback() {
                @Override
