...
public class SdofViewCtrl {
    ...
    private static final int SDOF_VIEW_SET_VISIBLE = 8;
    ...
    public static boolean barTouching = false;
    ...
    public void init(IApp app) {
        ...
        if (cs != null) {
            ...
            if (zoomSets != null && zoomSets.length > 1){
                showZoom = true;
            }
    ...
    public void setVisible(boolean visible) {
        if (mMainHandler != null) {
            mMainHandler.obtainMessage(SDOF_VIEW_SET_VISIBLE, visible).sendToTarget();
        }
    }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case SDOF_VIEW_INIT_AND_SHOW:
                    initView();
                    break;
                case SDOF_VIEW_SET_VISIBLE:
                    setViewVisible((Boolean) msg.obj);
                    break;
    ...
    private void setViewVisible(boolean visible) {
        if (mSdofLayout != null) {
            mSdofLayout.setVisibility(visible ? View.VISIBLE : View.INVISIBLE);
        }
    }
    ...
    private void updateOrientation(int orientation) {
        if (showZoom){
            LogHelper.w(TAG, "[updateOrientation] return, need show zoom bar");
            return;
        }
        if (mSdofView == null) {
    ...
    private SeekBar.OnSeekBarChangeListener mChangeListener
        ...
        public void onProgressChanged(SeekBar seekBar, int progress, boolean b) {
            if (showZoom && DualZoomViewCtrl.zoomTouching){
                LogHelper.i(TAG, "onProgressChanged return, DualZoom is touching");
                return;
            }
        ...
        public void onStartTrackingTouch(SeekBar seekBar) {
            if (showZoom) {
                if (DualZoomViewCtrl.zoomTouching){
                    LogHelper.i(TAG, "onStartTrackingTouch return, DualZoom is touching");
                    return;
                }
                barTouching = true;
            }
        ...
        public void onStopTrackingTouch(SeekBar seekBar) {
            if (showZoom && DualZoomViewCtrl.zoomTouching){
                LogHelper.i(TAG, "onStopTrackingTouch return, DualZoom is touching");
                return;
            }
            barTouching = false;
