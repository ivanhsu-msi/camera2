...
class QRcodeRestriction {
    private static final String QRCODE_MODE_KEY =
            "com.mediatek.camera.feature.mode.qrcode.QRcodeMode";
    private static RelationGroup sRelationGroup = new RelationGroup();
    static {
        sRelationGroup.setHeaderKey(QRCODE_MODE_KEY);
        ...
        sRelationGroup.addRelation(
                new Relation.Builder(QRCODE_MODE_KEY, "on")
                        .addBody("key_hdr", "off", "off")
                        .addBody("key_camera_switcher", "back", "back")
                        .addBody("key_flash", "off", "on,off")
