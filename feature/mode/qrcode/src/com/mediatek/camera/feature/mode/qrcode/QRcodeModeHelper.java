...
/**
 * Created by vend_wsd_am_029 on 2019/5/24.
 */

class QRcodeModeHelper {
     ...
     */
    public QRcodeModeHelper(ICameraContext cameraContext) {
        mICameraContext = cameraContext;
        mImageFileName = new QRcodeModeHelper.ImageFileName(IMAGE_FORMAT);
    }
