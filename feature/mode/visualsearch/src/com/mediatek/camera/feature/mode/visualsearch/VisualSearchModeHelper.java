...
class VisualSearchModeHelper {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(VisualSearchModeHelper.class.getSimpleName());
     ...
     */
    public VisualSearchModeHelper(ICameraContext cameraContext) {
    ...
    public ContentValues createContentValues(byte[] data, String fileDirectory, int
        ...
        LogHelper.d(TAG, "createContentValues, width : " + pictureWidth + ",height = " +
                ...
                + ", filePath = " + fileDirectory + ", fileName = " + fileName);
        return values;
    }
