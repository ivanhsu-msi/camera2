...
class HdrRestriction {
    ...
    static {
        ...
        sRelationGroup.setBodyKeys("key_flash, key_scene_mode, key_dng, key_continuous_shot" +
                ", key_white_balance, key_color_effect, key_zsd,key_iso, key_asd" +
                ",key_brightness,key_contrast,key_hue,key_saturation,key_sharpness,key_fps60,key_exposure,key_focus");
        ...
        sRelationGroup.addRelation(
                new Relation.Builder("key_hdr", "auto")
                        ...
                        .addBody("key_focus", "focus-lock", "false")
                        .build());
    }
