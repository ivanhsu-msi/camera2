...
/**
 * HDR10+ entry for feature provider.
 */

public class Hdr10Entry extends FeatureEntryBase {
    private Hdr10 mHdr10 = null;
    private static final LogUtil.Tag TAG = new LogUtil.Tag(Hdr10Entry.class.getSimpleName());
     ...
     */
    public Hdr10Entry(Context context, Resources resources) {
    ...
    public boolean isSupport(CameraApi currentCameraApi, Activity activity) {
        ...
        boolean enable = SystemProperties.getInt("ro.vendor.hdr10plus.enable", 0) == 1;
        boolean pfSupport = isPfSupportStandard("0");
        LogHelper.d(TAG, "isPlatformSupportStandard" + pfSupport);
        return enable && !pfSupport;
    }

    private boolean isPfSupportStandard(String cameraId) {
    ...
    public String getFeatureEntryName() {
        return Hdr10Entry.class.getName();
    }
