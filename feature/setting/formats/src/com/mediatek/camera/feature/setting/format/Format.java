...
public class Format extends SettingBase implements IAppUiListener.OnShutterButtonListener {
    ...
    public void addViewEntry() {
        if(mFormatSettingView == null){
            mFormatSettingView = new FormatSettingView();
    ...
    public void overrideValues(@Nonnull String headerKey, String currentValue,
        ...
        LogHelper.d(TAG,"[overrideValues] - headerKey = " + headerKey + " lastValue = "
                + lastValue + " supportValues " +supportValues);
    }
    ...
    public ICaptureRequestConfigure getCaptureRequestConfigure() {
        if (mSettingChangeRequester == null) {
            mSettingChangeRequester
                    = new FormatCaptureRequestConfig(mActivity.getApplicationContext(),
    ...
    public void onModeClosed(String modeKey) {
        ...
        mSettingController.postRestriction(
                    FormatRestriction.getRestriction().getRelation(IFormatViewListener.KEY_FORMAT, true));
    }
    ...
    public void initializeValue(List<String> supportedFormats) {
        mSupportValues.clear();
        mSupportValues.addAll(supportedFormats);
