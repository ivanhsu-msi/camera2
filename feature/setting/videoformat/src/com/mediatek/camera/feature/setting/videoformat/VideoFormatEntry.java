 ...
 * Video format entry.
 */
public class VideoFormatEntry extends FeatureEntryBase {
    /**
     * create an entry.
     *
     ...
     */
    public VideoFormatEntry(Context context, Resources resources) {
    ...
    public String getFeatureEntryName() {
        return VideoFormatEntry.class.getName();
    }
