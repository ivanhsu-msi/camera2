...
public class ZoomEntry extends FeatureEntryBase {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(ZoomEntry.class.getSimpleName());
    /**
     * create an entry.
     *
    ...
    private boolean isDualCameraSupport() {
        if (CameraUtil.getDualZoomId() != null) {
            LogHelper.d(TAG, "[isDualCameraSupport] support dual zoom.");
            return true;
        }
        return false;
    }
