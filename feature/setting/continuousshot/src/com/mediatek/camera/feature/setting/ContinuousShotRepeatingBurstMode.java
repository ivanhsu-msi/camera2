...
public class ContinuousShotRepeatingBurstMode extends ContinuousShotBase
        implements ICaptureRequestConfigure, OnShutterButtonListener {
    private static final Tag TAG = new Tag(ContinuousShotRepeatingBurstMode.class.getSimpleName());
    ...
    private void createCaptureRequest(boolean isFirstRequest)
        ...
        session.setRepeatingBurst(requests, mCaptureCallback, mHandler);
    }
    ...
    private final CameraCaptureSession.CaptureCallback mCaptureCallback = new
        ...
        public void onCaptureCompleted(CameraCaptureSession session, CaptureRequest request,
            ...
            if (CameraUtil.isStillCaptureTemplate(result)) {
                synchronized (mNumberLock) {
                    mStillCaptureNumber++;
                    LogHelper.d(TAG, "[onCaptureCompleted] still capture: " + mStillCaptureNumber
