...
/**
 * Standard HDR10 selector.
 */

public class StandardHDR10Selector extends PreferenceFragment {
    private static final LogUtil.Tag TAG
            = new LogUtil.Tag(StandardHDR10Selector.class.getSimpleName());
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(getActivity().getResources().getString(R.string.standard_hdr10_title));
        addPreferencesFromResource(R.xml.standard_hdr10_selector_preference);
    ...
    private void filterValuesOnShown() {
        ...
        for (int i = 0; i < tempValues.size(); i++) {
            ...
            String resolution = StandardHDR10Helper.getQualityTitle(mActivity, value);
            String title = StandardHDR10Helper.getQualityTitle(mActivity, value);
            if (title != null) {
