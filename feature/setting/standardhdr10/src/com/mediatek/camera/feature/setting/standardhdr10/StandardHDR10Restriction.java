...
public class StandardHDR10Restriction {
     ...
     */
    static {
        mOffHfpsRelationGroup.setHeaderKey("key_standard_hdr10");
        mOffHfpsRelationGroup.setBodyKeys("key_eis");
        mOffHfpsRelationGroup.replaceRelation(
                new Relation.Builder("key_standard_hdr10",
                        "2")
    ...
    static {
        mSupHfpsRelationGroup.setHeaderKey("key_standard_hdr10");
