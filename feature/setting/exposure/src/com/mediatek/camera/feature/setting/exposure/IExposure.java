...
public interface IExposure {
    ...
    interface Listener {
        ...
        /**
         * Get whether panel flash flow is during restore ae mode
         *
         * @return True if standard panel flash flow sent STILL_CAPTURE capture intent
         * but not restored ae mode,during this time could not do capture
         */
        boolean isStandardFlowPanelFlashCaptureProcessing();
    }
}
