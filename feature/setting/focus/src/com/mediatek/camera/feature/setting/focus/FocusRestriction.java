...
class FocusRestriction {
    ...
    /**
     * Restriction when AE/AF has been loced. Only PhotoMode need turn off Flash
     * @return restriction list.
     */
    static RelationGroup getAeAfLockRestriction(ICameraMode.ModeType modeType) {
        if (modeType== ICameraMode.ModeType.PHOTO){
