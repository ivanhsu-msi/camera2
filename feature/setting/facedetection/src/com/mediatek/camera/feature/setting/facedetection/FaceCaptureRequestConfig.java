...
public class FaceCaptureRequestConfig implements ICameraSetting.ICaptureRequestConfigure,
    ...
    private String mFaceDetectMode = SystemProperties.getString("vendor.mtk.camera.app.face.detect.mode", "0");
    ...
    public void configCaptureRequest(CaptureRequest.Builder captureBuilder) {
        ...
        if (mFaceMonitor.isNeedToStart()) {
            LogHelper.i(TAG, "[configCaptureRequest] start face detection, this: " + this + ",mFaceDetectMode:" + mFaceDetectMode);
            if ("0".equals(mFaceDetectMode)){
    ...
    private Face[] getFaces(android.hardware.camera2.params.Face[] faces,
        ...
        if (faces == null || (faces != null && faces.length == 0)||(cropRegion == null)) {
            return null;
        }
