...
public class FaceDetection extends SettingBase {
    ...
    public void init(IApp app,
        ...
        mStatusMonitor.registerValueChangedListener(OBJECT_EXIST_KEY, mFaceViewCtrl);
    ...
    public void unInit() {
        ...
        mStatusMonitor.unregisterValueChangedListener(OBJECT_EXIST_KEY, mFaceViewCtrl);
    ...
    private IFaceConfig.OnFaceValueUpdateListener mOnFaceValueUpdateListener
        ...
        public Size onFacePreviewSizeUpdate() {
            LogHelper.d(TAG, "[onFacePreviewSizeUpdate]");
