...
public class ObjectTrackingRestriction {
    ...
    static {
        sRelationGroup.setHeaderKey(KEY_OBJECT_TRACKING);
        sRelationGroup.setBodyKeys("key_hdr");
        sRelationGroup.addRelation(
                new Relation.Builder(KEY_OBJECT_TRACKING, "on")
                        .addBody("key_hdr", "off", "off,on,auto")
                        .build());
    }

    static RelationGroup getObjectTrackingRestriction() {
