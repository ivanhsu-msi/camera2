...
public class AINRRestriction {
    private static RelationGroup sRelationGroup = new RelationGroup();
    static {
        sRelationGroup.setHeaderKey("key_ainr");
        sRelationGroup.setBodyKeys("key_fps60");
        sRelationGroup.addRelation(
                new Relation.Builder("key_ainr", "on")
                        .addBody("key_fps60", "off", "off")
                        .build());
    }

    /**
     * Get AINR restriction.
     *
