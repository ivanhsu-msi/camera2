        ...
        mActivity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                if (mSettingView != null) {
                    Fps60CaptureRequestConfig captureRequestConfig = (Fps60CaptureRequestConfig)getCaptureRequestConfigure();
                    String value = mDataStore.getValue(KEY_VIDEO_QUALITY, "1", getStoreScope());

                    if(!captureRequestConfig.isFPS60Support(value)){
                        LogHelper.d(TAG, "[refreshViewEntry] 60 fps do not Support,video quality value: " +value);
                        mSettingView.setChecked(false);
