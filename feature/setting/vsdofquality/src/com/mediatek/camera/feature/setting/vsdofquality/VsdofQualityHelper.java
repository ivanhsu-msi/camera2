...
/**
 * Vsdof quality helper to provide util methods.
 */
public class VsdofQualityHelper {
    ...
    /**
     * The google default Vsdof qualities sorted by size.
     */
    static int[] sVsdofQualities = new int[] {
    ...
    /**
     * The mtk default Vsdof qualities sorted by size.
     */
    static int[] sMtkVsdofQualities = new int[] {
