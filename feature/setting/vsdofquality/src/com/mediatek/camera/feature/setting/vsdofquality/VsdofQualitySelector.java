...
/**
 * Vsdof quality selector.
 */

public class VsdofQualitySelector extends PreferenceFragment {
    private static final LogUtil.Tag TAG
            = new LogUtil.Tag(VsdofQualitySelector.class.getSimpleName());
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.vsdofquality_selector_preference);
    ...
    private void filterValuesOnShown() {
        ...
        for (int i = 0; i < tempValues.size(); i++) {
            ...
            String resolution = VsdofQualityHelper.getCurrentResolution(mCameraID, value);
            String title = VsdofQualityHelper.getQualityTitle(mActivity, value, mCameraID);
            if (title != null) {
